            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h6 class="m-0 font-weight-bold">Edit pages</h6>
                    </div>
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card alert bg-light shadow p-3 mb-5 bg-body rounded text-center">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary text-center">Edit Halaman</h6>
                                </div>
                                <div class="card-body">
                                    <form action="/create" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <input type="text" class="form-control text-center" id="title" name="title" value="{{$page['title']}}">
                                        </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="mb-4">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-4">
                                                ...
                                                <input type="text" class="form-control text-center" id="link" name="link" value="{{$page['link']}}">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="mb-4">
                                                <button type="submit" class="btn btn-primary font-weight-bold">Ubah Halaman</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
