            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h6 class="m-0 font-weight-bold">Page Data</h6>
                    </div>
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card alert bg-light shadow p-3 mb-5 bg-body rounded">
                                <div class="card-header py-3 ">
                                    <h6 class="m-0 font-weight-bold text-primary text-center">Daftar Halaman</h6>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table" id="table_siswa">
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$page['link']}}</td>
                                                <td class="d-flex">
                                                    <form action="/admin/edit/{{$page['id']}}" method="get">
