            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @foreach ($page as $pages1)
                        <a class="collapse-item" href="/pages/{{$pages1['link']}}">{{$pages1['title']}}</a>
                        @endforeach
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <span class="nav-link text-primary font-weight-bold">Artikel Tentang {{$pages['title']}}</span>
                    <div class="topbar-divider d-none d-sm-block"></div>
                    <span class="nav-link font-weight-bold">Di tambahkan oleh {{$penyusun['0']}}</span>
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card alert bg-light shadow p-3 mb-5 bg-body rounded">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary text-center">{{$pages['title']}}</h6>
                                    {{-- <h6 class="m-0 font-weight-bold text-secondary" style="font-size: 15px"></h6> --}}
                                </div>
                                <div class="card-body">
                                    <span>{!! nl2br($pages["isi"]) !!}</span>
                                </div>
                            </div>
                        </div>
                    </div>
